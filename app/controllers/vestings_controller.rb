class VestingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @vesting.save
        format.html { redirect_to pool_vesting_path(@pool, @vesting), notice: "Vesting was successfully created." }
  ...
  def update
    respond_to do |format|
      if @vesting.update(vesting_params)
        format.html { redirect_to pool_vesting_path(@pool), notice: "Vesting was successfully updated." }
